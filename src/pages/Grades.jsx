...
function Grades() {
  return (
    <div className="min-h-screen relative" style={{ 
      backgroundImage: `url(/src/assets/grades.jpeg)`, 
      ...
      <div className="pt-24 p-6">
        ...
        >
          <h1 className="text-3xl font-bold text-white mb-4">Grades</h1>
          <p className="text-blue-200">Your grades will appear here with a beautiful background image.</p>
        </motion.div>
      </div>
      ...
      >
        <div className="flex justify-around items-center py-4 px-6">
          ...
          <Link to="/grades" className="bottom-nav-link">
            <BarChart3 className="w-6 h-6 bottom-nav-item active" />
          </Link>
